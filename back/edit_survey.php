...
foreach($options as $key =>$opt){
    ...
    if($key>1){
        $star = '';
        $deleteBtn = "<a href='./api/del_option.php?id={$opt['id']}&subject_id={$opt['subject_id']}&admin' class='btn btn-main float-right ms-auto del-exist-option-btn'><i class='fa-solid fa-trash-can del-exist-option-btn'></i></a><div class='clearfix'></div>";
    }
    ?>
    <div class="mb-3">
